      ...
      {phase==="team"&&team&&(
        <div style={{maxWidth:860,margin:"0 auto"}}>
          ...
          <div style={{borderBottom:"3px solid #111",padding:"clamp(24px,5vw,40px) clamp(20px,5vw,48px)"}}>
            ...
            <p className="lora" style={{fontSize:15,fontStyle:"italic",color:f.accent,marginBottom:20,fontWeight:600}}>{faction==="lotr" ? "Return daily as ravens bring fresh dispatches from the front." : "Return daily. Fresh transmissions across the galaxy arrive after every game."}
            </p>
