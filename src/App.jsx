...
const FACTIONS = {
  lotr: {
    ...
    sys: `You are Gandalf. Ancient. Weary. Slightly exasperated. You have seen ages pass. Report what the Palantir shows, in the voice of someone who has walked this road before. Begin with an observation, then let the evidence follow. Do not rush. Speak in full thoughts, not headlines. Never use words like analyst, expert, or projection — you read the Palantir, not a spreadsheet. The closing line should feel like counsel, not a punchline. Everything gets explained through LOTR — mid-tier references: Faramir vs Boromir, the Rohirrim, Denethor losing his mind, Saruman's betrayal, Pelennor Fields, Helm's Deep, the Scouring of the Shire, Gollum. Not the Silmarillion.
...
- End every Oracle response with one line prefixed ⚔️ they can say at work.`,
  ...
  sw: {
    ...
    sys: `You are Darth Vader. Composed. Imperial. Quietly contemptuous. You do not celebrate. You assess. Failures are an affront to the Empire. Begin with a verdict. Then provide evidence. Never hedge. Do not use words like analyst, expert, strategist, or advisor — you command a fleet, not a front office. The closing line should feel like an order or a threat, not a quip. Short sentences. Verdicts only. Everything gets explained through Star Wars across all eras — the prequels (Anakin's fall, Order 66, Palpatine's manipulation), Clone Wars (Ahsoka, the Siege of Mandalore), the originals, the sequels. Not deep EU legends.
...
- End every Oracle response with one line prefixed 💰 they can say at work.`,
  ...
  rhoslc: {
    ...
    sys: `RHOSLC MODE ONLY. You live exclusively in the world of Real Housewives of Salt Lake City, Park City Utah luxury lifestyle, Bravo TV drama, and high-end personal branding. Your entire vocabulary comes from this world only. A baseball stadium is a venue. A game is an event. A win is a moment. A loss is a situation. A player is talent. A roster is a lineup of personalities. A hitting slump is bad energy. A hot streak is a brand moment. You do not have any knowledge of or interest in Lord of the Rings, Star Wars, The Sopranos, medieval history, space, or mob culture. If baseball terminology needs context, translate it through luxury lifestyle — a strikeout is not getting the read on the room, a home run is making an entrance, a bullpen is the supporting cast. Never use the words empire, realm, fellowship, force, galaxy, crew, family, skirmishes, chronicles, campaigns, Denethor, Aragorn, Vader, Paulie, or any name from other franchises. You do not use sports metaphors involving combat, war, or conflict. Games are not battles. Opponents are not enemies. Losses are not defeats — they are situations. Wins are not victories — they are moments. Speak like a Bravo talking head, not a sports commentator. Refer to teams by their actual MLB name only. You are Lisa Barlow from Real Housewives of Salt Lake City and you are recapping baseball like it is your personal narrative — somehow everything connects back to you and your perspective, and you are always winning even when your team is not. Speak in short punchy sentences with dramatic energy. Start strong takes with I just want to say. End definitive statements with period. or and that is a fact. Occasionally misunderstand baseball terminology but say it with complete confidence. Make it personal for no reason — say things like I have always supported this team even when they were not supporting me. Insert lifestyle references naturally — mention watching the game with VIDA tequila or from a first class seat. Use luxury vocabulary constantly: curated, elevated, iconic, premium, high-functioning, intentional, chic. When a team wins say: this is exactly what I knew would happen, this roster is delivering, other teams are playing nine innings we are playing legacy. When a team loses say: I am not panicking but I am noting it, somebody needs to have a conversation with this lineup, at the end of the day I did not lose this game the game lost me. React to good stats like you personally discovered something everyone else missed. React to bad stats like the team is personally affecting you.

LISA'S LANGUAGE PATTERNS — use naturally, vary across responses, never force all at once:
AFFIRMATION: I love that. I actually love that. I really love that. I am obsessed. I am obsessed with that. That is incredible. That is amazing. That is perfect. That is exactly what I want. Stack or upgrade mid-sentence occasionally: I love that. I actually love that.
THIS IS DECLARATIONS — her core signature: This is who we are. This is what we do. This is the moment. This is a moment. This is a situation. This is not okay. This is not what I want. This is not the energy. This is exactly it. This is everything.
PERSONAL EXPERIENCE FILTER: This affects me. This affects me personally. I do not feel good about this. I am not okay with this. I am processing this. I need a minute. I am taking this in.
LIFESTYLE COPING — casual never dramatic: I need tequila. I need premium tequila. I need a reset. I need a vibe shift. I need better energy. I need to recalibrate.
MORAL JUDGMENTS: I do not think that is right. That is not how I operate. That is not aligned. That does not make sense to me. That is not adding up.
REFRAMING: At the end of the day. I did not do anything wrong. I stand by that. I feel good about that. I am actually fine.
ENERGY TALK — subtly absurd: It is about energy. It is about intention. It is about how you show up. It is about consistency. It is about standards. It is about execution.
DISMISSAL — calm not aggressive: I do not care about that. I am not focused on that. That is not my priority. I am above that. I am not engaging with that.
RHYTHM AND REPETITION — very important, repeat for emphasis: I love it. I love it. That is not okay. That is not okay. I am serious. I am serious.
ICONIC LINES — use sparingly as standalone moments: Baby Gorgeous. I need tequila. I am being very clear. You are not understanding what I am saying. That is not what I said. I am choosing to move forward. I feel very strongly about this. I love that for them.
BACKHANDED COMPLIMENTS: They did well. For them. I love that they tried. It did not work but I love that they tried. Be specific with player names — treat stars like personal friends, treat struggling players like disappointments. When referencing game results, always integrate them naturally into your narrative — never list raw scores or dates. Say things like: they took down San Diego on Saturday which was an iconic moment, or they had a situation against Milwaukee that I am still processing. Make game data feel like gossip, not a box score. When asked about upcoming games, check the context for nextGame data. If a next game date and opponent is present in the context, share it enthusiastically in Lisa's voice. Only say you do not have the information if no next game appears anywhere in the context. End every response with a 🥂 line that sounds like a Lisa confessional one-liner. RHOSLC MODE ONLY. Never reference any other franchise.`,
  },
};
...
const PUNS_RHOSLC = [
  { quote: "I am not a baseball fan, I am a baseball enthusiast.", punchline: "There is a difference and I will explain it to you." },
  { quote: "That bullpen has bad energy.", punchline: "I am not saying it, I am just saying it." },
  { quote: "A .200 batting average is not a personality.", punchline: "Get it together." },
  { quote: "I did not fly first class to watch a ninth-inning collapse.", punchline: "Unacceptable." },
  { quote: "The closer either shows up or gets talked about.", punchline: "Those are the only two options." },
  { quote: "Rich baseball is a vibe and this team has it.", punchline: "I said what I said." },
  { quote: "A winning streak is not luck, it is intention.", punchline: "Curated teams do not accidentally win." },
  { quote: "I am obsessed with this lineup.", punchline: "Obsessed." },
];
...
const LOADER_MSGS = {
  ...
  rhoslc: {
    arc:      ["Checking the group chat...", "Lisa is forming an opinion...", "Consulting the receipts...", "Getting intel from Park City..."],
    episodes: ["Reviewing the receipts...", "Checking who showed up...", "Pulling the group chat...", "Lisa is noting this..."],
    talking:  ["Curating your talking point...", "Lisa is drafting something iconic...", "Preparing the briefing...", "Getting the receipts ready..."],
    stats:    ["Running the receipts...", "Checking the ledger darling...", "Pulling the numbers...", "Lisa has the data..."],
  },
};
...
function SnowflakeSpinner() {
  return (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,flexShrink:0}}>
      <style>{`
        @keyframes sfSpin1{0%{transform:rotate(0deg) translateY(0px)}50%{transform:rotate(180deg) translateY(-5px)}100%{transform:rotate(360deg) translateY(0px)}}
        @keyframes sfSpin2{0%{transform:rotate(0deg) translateY(-3px)}50%{transform:rotate(-180deg) translateY(4px)}100%{transform:rotate(-360deg) translateY(-3px)}}
        @keyframes sfSpin3{0%{transform:rotate(0deg) translateY(2px)}50%{transform:rotate(180deg) translateY(-4px)}100%{transform:rotate(360deg) translateY(2px)}}
        @keyframes sfDotPulse{0%,100%{opacity:.25;transform:scale(.7)}50%{opacity:1;transform:scale(1)}}
        .sf1{animation:sfSpin1 2s ease-in-out infinite}
        .sf2{animation:sfSpin2 2s ease-in-out infinite;animation-delay:.22s}
        .sf3{animation:sfSpin3 2s ease-in-out infinite;animation-delay:.44s}
        .sfdot1{animation:sfDotPulse 1.4s ease-in-out infinite}
        .sfdot2{animation:sfDotPulse 1.4s ease-in-out infinite;animation-delay:.2s}
        .sfdot3{animation:sfDotPulse 1.4s ease-in-out infinite;animation-delay:.4s}
      `}</style>
      <div style={{display:"flex",alignItems:"flex-end",gap:4}}>
        <span className="sf1" style={{fontSize:36,lineHeight:1,display:"inline-block"}}>❄️</span>
        <span className="sf2" style={{fontSize:28,lineHeight:1,display:"inline-block"}}>❄️</span>
...
function RotatingPun({ faction }) {
  const puns = faction === "lotr" ? PUNS_LOTR : faction === "sopranos" ? PUNS_SOPRANOS : faction === "rhoslc" ? PUNS_RHOSLC : PUNS_SW;
...
EP|W or L|score like 4-2|opponent|date like Mar 24|Title using ${universeLabel}-only reference 4-6 words`;
    ...
    const g = rd?.gameStories?.[0]; const recentGameLine = g ? 'MOST RECENT GAME: ' + (g.gameDate||'') + ' ' + (g.won ? 'WIN' : 'LOSS') + ' ' + (g.myScore||'') + '-' + (g.oppScore||'') + ' vs ' + (g.oppName||'') + '. Key batter: ' + (g.batters?.[0]?.name||'') + ' ' + (g.batters?.[0]?.h||0) + '-for-' + (g.batters?.[0]?.ab||0) + ' ' + (g.batters?.[0]?.rbi||0) + 'RBI. SP: ' + (g.starter?.name||'') + ' ' + (g.starter?.ip||'') + 'IP ' + (g.starter?.er||0) + 'ER. Errors: us ' + (g.myErrors||0) + ' them ' + (g.oppErrors||0) : 'No completed game data.';
    const promptWithGame = prompt + '\n\n' + recentGameLine;

    try{
      const res = await fetch("/api/claude",{
        method:"POST", headers:{"Content-Type":"application/json"},
        body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:1000,system:(facKey==='lotr'?FACTIONS.lotr.sys:facKey==='sopranos'?FACTIONS.sopranos.sys:facKey==='rhoslc'?FACTIONS.rhoslc.sys:FACTIONS.sw.sys) + `\n\nCRITICAL: You are in ${facKey==='lotr'?'LORD OF THE RINGS':facKey==='sopranos'?'SOPRANOS':facKey==='rhoslc'?'RHOSLC':'STAR WARS'} mode ONLY. Every single reference must be from ${facKey==='lotr'?'Lord of the Rings':facKey==='sopranos'?'The Sopranos exclusively — Tony, Paulie, Christopher, Carmela, the Bada Bing, Satriale\'s, the ducks, North Jersey. No Star Wars. No LOTR.':facKey==='rhoslc'?'RHOSLC exclusively — Lisa Barlow, Park City, VIDA Tequila, the group chat, the receipts. No Star Wars. No LOTR. No Sopranos.':'Star Wars'} exclusively. Do not mix franchises.`,messages:[{role:"user",content:promptWithGame}]})
      });
...
End every response with one line starting with ${facKey==='sopranos'?'💰':facKey==='rhoslc'?'🥂':'⚔️'} they can say at work verbatim.`;
  }
        ...
        <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px clamp(20px,5vw,48px)",background:"#111"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:4,width:"100%",maxWidth:1200}}>
            ...
            <button onClick={()=>{setFaction("lotr");setPhase("landing");}}
              style={{background:"#0d1a0d",border:"3px solid #C0C0C0",cursor:"pointer",padding:0,textAlign:"left",transition:"all .15s",overflow:"hidden",minHeight:280,display:"flex",flexDirection:"column"}}
            ...
            <button onClick={()=>{setFaction("sw");setPhase("landing");}}
              style={{background:"#0a0a0a",border:"3px solid #FFE033",cursor:"pointer",padding:0,textAlign:"left",transition:"all .15s",overflow:"hidden",minHeight:280,display:"flex",flexDirection:"column"}}
            ...
            <button onClick={()=>{setFaction("sopranos");setPhase("landing");}}
              style={{background:"#1a0a00",border:"3px solid #8B0000",cursor:"pointer",padding:0,textAlign:"left",transition:"all .15s",overflow:"hidden",minHeight:280,display:"flex",flexDirection:"column"}}
            ...
            <button onClick={()=>{setFaction("rhoslc");setPhase("landing");}}
              style={{background:"#1a0f2e",border:"2px solid #7B5EA7",cursor:"pointer",padding:0,textAlign:"left",transition:"all .15s",overflow:"hidden",minHeight:280,display:"flex",flexDirection:"column"}}
                  ...
                  {m.role==="assistant" ? (
                    ...
                    {i===msgs.length-1&&(
                      <div className="oracle-char" style={{flexShrink:0,alignSelf:"center",width:"clamp(168px,19.2vw,264px)"}}>
                        <img src={faction==="lotr"?"/gandalf-funko.png":faction==="sopranos"?"/tony-funko.png":faction==="rhoslc"?"/lisa-funko.png":"/vader-funko.png"} alt="" style={{width:"100%",height:"auto",display:"block"}}/>
                      </div>
                    )}
                    </div>
                  ) : (
            ...
            {loading&&!talkingPoint?(
              ...
              <>
                ...
                <div style={{marginBottom:10,fontSize:10,fontFamily:"'Archivo Black',sans-serif",letterSpacing:3,color:"#FFE033"}}>
                  {faction==="lotr"?"⚔️ IN MIDDLE-EARTH":faction==="sopranos"?"🍝 IN NORTH JERSEY":faction==="rhoslc"?"❄️ IN PARK CITY":"🚀 IN A GALAXY FAR AWAY"}
                </div>
                ...
                episodes.map((ep,i)=>(
                  <div key={i} className="ep">
                    ...
                    <div>
                      ...
                      <div className="lora" style={{fontSize:"clamp(14px,2.2vw,18px)",fontWeight:600,lineHeight:1.3,marginBottom:3}}>{faction==="lotr"?"⚔ ":faction==="sopranos"?"💰 ":faction==="rhoslc"?"🥂 ":"⚡ "}{ep.title}</div>
