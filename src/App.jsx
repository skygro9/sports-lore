...
export default function SportsLore(){
  ...
  useEffect(()=>{chatEnd.current?.scrollIntoView({behavior:"smooth"});},[msgs,oLoading]);
...
EPISODES:
For each of the last 5 games (make them up if no data, but make them feel realistic for this team's record):
